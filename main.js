const applicationServerKey = "BEue9W6A1BnQAQlz_-ppP2Nq-awaNPK-s4qLK0cCJUGjMnSpL5EVbogQigiMvZHq-GFnxa_bgzGMMPU7mWvMFkw";
    ...
    pushButton.addEventListener('click', function () {
        ...
        if (isPushSubscribed) {
            ...
            getNotificationPermission().then(function (status) {
                ...
                handleNotificationPermissionError(error);
            });
        }
    });
});
...
function handleNotificationPermissionError(error) {
    if (error === "support") {
